...
export default function TitleBar() {
  const maximiseBtnSvg = (
    <svg viewBox="0 0 5 5" xmlns="http://www.w3.org/2000/svg">
      <path d="M1,1 h3v3h-3v-3 z" stroke="#cb2" strokeWidth="1" fill="none" />
    </svg>
  );
  const unmaximiseBtnSvg = (
    <svg viewBox="0 0 5 5" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M1.5,0.5v4m2,0v-4M0.5,1.5h4m0,2h-4"
        stroke="#cb2"
        strokeWidth="1"
        fill="none"
      />
  ...
  return (
    <header>
      ...
      <ul id={style["window-controls"]}>
        <li
          id={style["minimise-btn"]}
          onClick={(e) => ipcRenderer.send("minimise")}
        >
          <svg viewBox="0 0 5 5" xmlns="http://www.w3.org/2000/svg">
        ...
        <li
          id={style["window-btn"]}
          onClick={(e) => ipcRenderer.send("maximise")}
        >
          {windowBtnSvg}
        </li>
