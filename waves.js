/* Creating a wave effect on the background of the page. */
...
/* Creating a function called Waves. */
    this.Waves = function (holder, options) {
      var Waves = this;
  
   /* Setting the options for the waves.js library. */
  ...
  /* This is creating a canvas element and appending it to the holder. */
    ...
    Waves.prototype.background = function () {
      ...
      var gradient = Waves.ctx.createLinearGradient(2, 0, 0, Waves.height);
